...
function OutgoingRecords() {
  ...
  const handleAddClick = () => {
    navigate("/add-outgoing"); // ✅ Works now
  };
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-3xl font-extrabold text-gray-800 dark:text-white">Outgoing Letters</h2>
        <button
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <p className="text-gray-600 dark:text-gray-400 mb-4">View and manage all outgoing letters</p>
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredRecords.length > 0 ? (
                filteredRecords.map((record, idx) => (
                  <tr key={record.id} className={`${idx % 2 === 0 ? "bg-gray-50 dark:bg-gray-800" : ""} hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200`}>
                ...
                <tr>
                  <td colSpan="7" className="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No matching records found</td>
                </tr>
              )}
            </tbody>
          </table>
